...
#'  @param data_file An optional string, indicating the name of the .db file where the query tree metadata will be stored locally.
...
#'
#' @export
flt_query <- function(conn, ems_name, data_file = NULL) {
